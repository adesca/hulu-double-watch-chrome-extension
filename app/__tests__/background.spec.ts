...
describe('background', function () {
    ...
    // // fit('should initialize with a port connection to content scripts on page_action click', function () {
    ...
    // //
    // //     expect(browser.pageAction.onClicked.countListeners()).toEqual(0);
    // //     const subjectBackground = new Background(browser);
    // //     expect(browser.pageAction.onClicked.countListeners()).toEqual(1);
    // //
